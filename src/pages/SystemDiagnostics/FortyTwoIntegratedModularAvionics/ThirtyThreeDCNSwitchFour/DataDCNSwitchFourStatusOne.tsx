...
const DataDCNSwitchFourStatusOne = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnswitchfour/datadcnswitchfourstatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233016'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'SWITCH 04 STATUS'} right={'1/3'} />
...
export default DataDCNSwitchFourStatusOne
