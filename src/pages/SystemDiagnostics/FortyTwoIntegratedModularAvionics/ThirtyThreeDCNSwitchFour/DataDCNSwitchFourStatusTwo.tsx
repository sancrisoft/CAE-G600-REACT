...
const DataDCNSwitchFourStatusTwo = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnswitchfour/datadcnswitchfourstatusthree',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233017'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'SWITCH 04 STATUS'} right={'2/3'} />
...
export default DataDCNSwitchFourStatusTwo
