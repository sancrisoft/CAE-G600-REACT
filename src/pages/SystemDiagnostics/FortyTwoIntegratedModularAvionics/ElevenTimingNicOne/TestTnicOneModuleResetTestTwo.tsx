...
const TestTnicOneModuleResetTestTwo = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'CONFIRM',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/eleventimingnicone/testtniconemoduleresettestpassed',
      disabled: false,
      position: 2,
    },
  ]
  ...
  return (
    ...
    >
      <DataHeader left={'TNIC1 MODULE RESET TEST'} right={'2/2'} />
...
export default TestTnicOneModuleResetTestTwo
