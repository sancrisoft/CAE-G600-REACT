...
const DataDCNRDCTwentyStatusOne = () => {
  ...
  const data = [
    ...
    { parameter: 'RIU 54 COMMS FAULT', status1: true, status2: true },
  ]
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnremotedataconcentratortwenty/datadcnrdctwentystatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233082'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'DCN RDC 20 STATUS'} right={'1/2'} />
...
export default DataDCNRDCTwentyStatusOne
