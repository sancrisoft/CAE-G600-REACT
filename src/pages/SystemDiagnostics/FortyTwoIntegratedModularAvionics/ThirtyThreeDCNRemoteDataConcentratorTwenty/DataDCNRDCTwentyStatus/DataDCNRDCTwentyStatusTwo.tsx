...
const DataDCNRDCTwentyStatusTwo = () => {
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233083'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RDC 20 STATUS'} right={'2/2'} />
...
export default DataDCNRDCTwentyStatusTwo
