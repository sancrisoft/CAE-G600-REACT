...
const DataDCNSwitchTwoStatusTwo = () => {
  ...
  const mainHeaders = [
    ...
    { title: '44         C', customSpan: 0, hasBorderBottom: true }, 
  ];
  
  const secHeaders = [
    { title: 'IOGM4', customSpan: 3, hasBorderBottom: true },
    { title: '44        C', customSpan: 1, hasBorderBottom: true },
  ];
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnswitchtwo/datadcnswitchtwostatusthree',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233007'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
...
export default DataDCNSwitchTwoStatusTwo
