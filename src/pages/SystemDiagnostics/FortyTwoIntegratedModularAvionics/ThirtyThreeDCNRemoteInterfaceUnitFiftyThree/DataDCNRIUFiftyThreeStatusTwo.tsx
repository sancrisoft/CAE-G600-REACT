...
const DataDCNRIUFiftyThreeStatusTwo = () => {
  const navigate = useNavigate();

  const tableHeader = [{ title: 'PARAMETER' }, { title: 'IOGM1' }, { title: 'IOGM4' }]
  const data = [
    { parameter: 'A429 RX B01', status1: true, status2: true },
    { parameter: 'A429 RX B01 BUFFER OVRFLW', status1: true, status2: true },
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233104'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RIU 53 STATUS'} right={'2/2'} />
...
export default DataDCNRIUFiftyThreeStatusTwo
