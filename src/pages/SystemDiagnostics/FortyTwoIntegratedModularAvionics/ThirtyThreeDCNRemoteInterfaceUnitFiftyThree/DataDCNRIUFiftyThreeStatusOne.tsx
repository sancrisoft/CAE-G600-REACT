...
const DataDCNRIUFiftyThreeStatusOne = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnremoteinterfaceunitfiftythree/datadcnriufiftythreestatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233103'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'DCN RIU 53 STATUS'} right={'1/2'} />
...
export default DataDCNRIUFiftyThreeStatusOne
