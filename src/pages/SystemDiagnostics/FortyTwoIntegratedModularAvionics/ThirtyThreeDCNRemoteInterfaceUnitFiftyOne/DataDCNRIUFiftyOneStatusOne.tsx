...
const DataDCNRIUFiftyOneStatusOne = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnremoteinterfaceunitfiftyone/datadcnriufiftyonestatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233099'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'DCN RIU 51 STATUS'} right={'1/2'} />
...
export default DataDCNRIUFiftyOneStatusOne
