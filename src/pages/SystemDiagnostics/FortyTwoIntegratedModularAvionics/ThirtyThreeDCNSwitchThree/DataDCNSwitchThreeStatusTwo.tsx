...
const DataDCNSwitchThreeStatusTwo = () => {
  ...
  const data2 = [
    { parameter: 'DATALOAD INHIBITED', status1: false, status2: false },
  ]
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnswitchthree/datadcnswitchthreestatusthree',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233012'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'SWITCH 03 STATUS'} right={'2/3'} />
...
export default DataDCNSwitchThreeStatusTwo
