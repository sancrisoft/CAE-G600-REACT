...
const TestPrcOneModuleResetTestTwo = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'CONFIRM',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/twentyoneprocessormoduleone/testprconemoduleresettestpassed',
      disabled: false,
      position: 2,
    },
  ]
  ...
  return (
    ...
    footer={
      ...
      <DataFooter left={'422112'} right={['Select confirm to continue']} />
      </>
    }
    >
...
export default TestPrcOneModuleResetTestTwo
