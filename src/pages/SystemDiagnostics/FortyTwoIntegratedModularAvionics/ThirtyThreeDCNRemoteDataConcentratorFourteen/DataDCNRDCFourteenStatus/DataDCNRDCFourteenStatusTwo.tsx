...
const DataDCNRDCFourteenStatusTwo = () => {
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233039'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RDC 14 STATUS'} right={'2/2'} />
...
export default DataDCNRDCFourteenStatusTwo
