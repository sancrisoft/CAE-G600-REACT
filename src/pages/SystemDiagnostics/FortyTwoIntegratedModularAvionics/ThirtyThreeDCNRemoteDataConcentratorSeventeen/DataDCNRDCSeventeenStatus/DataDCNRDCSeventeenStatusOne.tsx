...
const DataDCNRDCSeventeenStatusOne = () => {
  ...
  const data = [
    ...
    { parameter: 'RIU 51 CAPABILITY', status1: true, status2: true },
  ]
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnremotedataconcentratorseventeen/datadcnrdcseventeenstatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233057'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'DCN RDC 17 STATUS'} right={'1/2'} />
...
export default DataDCNRDCSeventeenStatusOne
