...
const DataDCNRDCFifteenStatusTwo = () => {
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233044'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RDC 15 STATUS'} right={'2/2'} />
...
export default DataDCNRDCFifteenStatusTwo
