...
const DataDCNRDCFifteenStatusOne = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnremotedataconcentratorfifteen/datadcnrdcfifteenstatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233043'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'DCN RDC 15 STATUS'} right={'1/2'} />
...
export default DataDCNRDCFifteenStatusOne
