...
const DataDCNRDCNineteenStatusTwo = () => {
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233075'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RDC 19 STATUS'} right={'2/2'} />
...
export default DataDCNRDCNineteenStatusTwo
