...
const DataDCNRIUFiftyFourStatusOne = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnremoteinterfaceunitfiftyfour/datadcnriufiftyfourstatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233105'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'DCN RIU 54 STATUS'} right={'1/2'} />
...
export default DataDCNRIUFiftyFourStatusOne
