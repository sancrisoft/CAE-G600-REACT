...
const DataDCNRIUFiftyFourStatusTwo = () => {
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233106'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RIU 54 STATUS'} right={'2/2'} />
...
export default DataDCNRIUFiftyFourStatusTwo
