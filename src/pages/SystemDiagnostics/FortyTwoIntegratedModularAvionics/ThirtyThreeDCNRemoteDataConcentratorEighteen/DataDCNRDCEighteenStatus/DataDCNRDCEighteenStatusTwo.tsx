...
const DataDCNRDCEighteenStatusTwo = () => {
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233065'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RDC 18 STATUS'} right={'2/2'} />
...
export default DataDCNRDCEighteenStatusTwo
