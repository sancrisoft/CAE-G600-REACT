...
const DataDCNRDCEighteenStatusOne = () => {
  ...
  const data = [
    ...
    { parameter: 'RIU 52 COMMS FAULT', status1: true, status2: true },
  ]
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnremotedataconcentratoreighteen/datadcnrdceighteenstatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233064'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'DCN RDC 18 STATUS'} right={'1/2'} />
...
export default DataDCNRDCEighteenStatusOne
