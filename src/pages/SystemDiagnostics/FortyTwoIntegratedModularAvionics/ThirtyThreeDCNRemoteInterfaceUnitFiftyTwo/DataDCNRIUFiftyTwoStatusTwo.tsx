...
const DataDCNRIUFiftyTwoStatusTwo = () => {
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233102'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RIU 52 STATUS'} right={'2/2'} />
...
export default DataDCNRIUFiftyTwoStatusTwo
