...
const DataDCNRDCThirteenStatusTwo = () => {
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233029'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RDC 13 STATUS'} right={'2/2'} />
...
export default DataDCNRDCThirteenStatusTwo
