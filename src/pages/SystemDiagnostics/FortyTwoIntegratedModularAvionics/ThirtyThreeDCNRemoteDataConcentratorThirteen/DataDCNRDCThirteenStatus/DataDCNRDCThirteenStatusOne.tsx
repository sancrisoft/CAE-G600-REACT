...
const DataDCNRDCThirteenStatusOne = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnremotedataconcentratorthirteen/datadcnrdcthirteenstatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233028'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'DCN RDC 13 STATUS'} right={'1/2'} />
...
export default DataDCNRDCThirteenStatusOne
