...
const DataDCNRDCTwelveStatusOne = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnremotedataconcentratortwelve/datadcnrdctwelvestatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233021'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'DCN RDC 12 STATUS'} right={'1/2'} />
...
export default DataDCNRDCTwelveStatusOne
