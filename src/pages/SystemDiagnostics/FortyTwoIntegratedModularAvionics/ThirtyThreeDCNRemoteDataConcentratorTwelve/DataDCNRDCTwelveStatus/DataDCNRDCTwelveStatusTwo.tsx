...
const DataDCNRDCTwelveStatusTwo = () => {
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233022'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RDC 12 STATUS'} right={'2/2'} />
...
export default DataDCNRDCTwelveStatusTwo
