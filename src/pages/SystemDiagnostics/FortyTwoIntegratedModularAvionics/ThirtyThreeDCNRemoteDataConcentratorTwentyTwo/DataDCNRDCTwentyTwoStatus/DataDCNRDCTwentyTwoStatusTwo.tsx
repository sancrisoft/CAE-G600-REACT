...
const DataDCNRDCTwentyTwoStatusTwo = () => {
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233094'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'DCN RDC 22 STATUS'} right={'2/2'} />
...
export default DataDCNRDCTwentyTwoStatusTwo
