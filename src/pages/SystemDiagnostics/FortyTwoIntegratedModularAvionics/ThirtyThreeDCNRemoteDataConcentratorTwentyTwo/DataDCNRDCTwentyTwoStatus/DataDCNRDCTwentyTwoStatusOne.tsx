...
const DataDCNRDCTwentyTwoStatusOne = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnremotedataconcentratortwentytwo/datadcnrdctwentytwostatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233093'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'DCN RDC 22 STATUS'} right={'1/2'} />
...
export default DataDCNRDCTwentyTwoStatusOne
