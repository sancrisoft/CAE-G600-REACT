...
const DataDCNSwitchOneStatusOne = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/fortytwointegratedmodularavionics/thirtythreedcnswitchone/datadcnswitchonestatustwo',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'4233001'} right={['Select PWD to continue']} />}
    >
      <DataHeader left={'SWITCH 01 STATUS'} right={'1/3'} />
...
export default DataDCNSwitchOneStatusOne
