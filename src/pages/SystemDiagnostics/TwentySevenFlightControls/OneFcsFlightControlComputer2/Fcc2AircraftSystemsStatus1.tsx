...
const Fcc2AircraftSystemsStatus1 = () => {
  ...
  const data2 = [
    ...
    { parameter: 'FCS NO DISPATCH', statuses: [true, true] },
  ]
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/twentysevenflightcontrols/onefcsflightcontrolcomputer2/fcc2aircraftsystemsstatus2',
      disabled: false,
      position: 5,
    },
  ]
...
export default Fcc2AircraftSystemsStatus1
