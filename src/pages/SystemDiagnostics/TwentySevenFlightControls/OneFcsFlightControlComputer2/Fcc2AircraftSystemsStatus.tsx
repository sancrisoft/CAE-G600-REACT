...
const Fcc2AircraftSystemsStatus = () => {
  ...
  const data = [
    ...
    { parameter: 'FCC ALTERNATE MODE', statuses: [true, true] },
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/twentysevenflightcontrols/onefcsflightcontrolcomputer2/fcc2aircraftsystemsstatus1',
      disabled: false,
      position: 5,
    },
  ]
...
export default Fcc2AircraftSystemsStatus
