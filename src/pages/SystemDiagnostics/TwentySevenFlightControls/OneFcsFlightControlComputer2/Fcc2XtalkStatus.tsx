...
const Fcc2XtalkStatus = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      type: ['square', 'noData', 'square', 'square'],
      alignCenter: true,
    },
    {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    },
    {
      ...
      disabled: false,
      position: 5,
      href: '/systemdiagnostics/twentysevenflightcontrols/onefcsflightcontrolcomputer2/fcc2xtalkstatus1',
    },
  ]
...
export default Fcc2XtalkStatus
