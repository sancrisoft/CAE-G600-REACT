...
const Fcc2EngagementStatus3 = () => {
  ...
  const data = [{ parameter: 'RUD PEDAL FORCE ENGAGED', statuses: [false, true, true, false] }]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'270135'} right={['Select done to continue', 'select prev to go back']} />}
    >
...
export default Fcc2EngagementStatus3
