...
const Fcc2ValidityStatus = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
...

    {
      ...
      disabled: false,
      position: 5,
      href: '/systemdiagnostics/twentysevenflightcontrols/onefcsflightcontrolcomputer2/fcc2validitystatus1',
    },
  ]
...
export default Fcc2ValidityStatus
