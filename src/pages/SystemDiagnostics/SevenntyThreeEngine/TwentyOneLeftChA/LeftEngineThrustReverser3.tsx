...
const LeftEngineThrustReverser3 = () => {
  ...
  const data = [
    ...
    { parameter: 'T/R LEFT LOWER LVDT', statuses: ['N/A', '-0.18 IN'], customSpan: 2 },
    { parameter: 'T/R RIGHT UPPER LVDT', statuses: ['N/A', '-0.17 IN'], customSpan: 2 },
    { parameter: 'T/R RIGHT LOWER LVDT', statuses: ['-0.17 IN', 'N/A'], customSpan: 2 },
    { parameter: '', statuses: ['', ''], customSpan: 2 },
    ...
    { parameter: 'T/R PRESSURE (PSIA)', statuses: ['22', '22'], customSpan: 2 },
    { parameter: 'T/R PRESSURIZED', statuses: ['', ''], customSpan: 2 },
  ];
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'703003'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'left engine thrust reverser status'} right={'3/3'} />
...
export default LeftEngineThrustReverser3;
