...
const LeftEngineStartStatus1 = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'fwd',
      href: '/systemdiagnostics/seventythreengine/twnetyoneleftcha/leftenginestartstatus2',
      disabled: false,
      position: 5,
    },
  ];
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'801101'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'left engine start status'} right={'1/2'} />
...
export default LeftEngineStartStatus1;
