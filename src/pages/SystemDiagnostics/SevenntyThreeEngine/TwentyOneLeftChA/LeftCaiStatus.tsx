...
const LeftCaiStatus = () => {
  ...
  const data = [
    ...
    { parameter: 'BURNER PRESSURE', statuses: ['14.7 PSIG', '14.7 PSIG'], customSpan: 2 },
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'300001'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'left engine cai system status'} right={'1/1'} />
