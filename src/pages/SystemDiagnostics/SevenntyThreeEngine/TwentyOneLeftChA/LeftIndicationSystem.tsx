...
const LeftIndicationSystem = () => {
  ...
  const data = [
    ...
    { parameter: 'N1 T/O RATING', statuses: ['95.48%', '95.48%'], customSpan: 2 },
    ...
    { parameter: 'ENGINE BROADBAND VIB', statuses: ['0.04 IPS', '0.03 IPS'], customSpan: 2 },
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'771001'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'left engine indication system'} right={'1/1'} />
...
export default LeftIndicationSystem;
