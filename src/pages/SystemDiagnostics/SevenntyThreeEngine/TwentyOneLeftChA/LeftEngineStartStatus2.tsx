...
const LeftEngineStartStatus2 = () => {
  ...
  const data = [
    ...
    { parameter: 'MOT', statuses: ['28.1', '28.1 DEGC'], customSpan: 2 },
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'801102'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'left engine start status'} right={'2/2'} />
...
export default LeftEngineStartStatus2;
