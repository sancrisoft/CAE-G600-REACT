...
const LeftEngineThrustReverser2 = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'fwd',
      href: '/systemdiagnostics/seventythreengine/twnetyoneleftcha/leftenginethrustreverser3',
      disabled: false,
      position: 5,
    },
  ];
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'703002'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'left engine thrust reverser status'} right={'2/3'} />
...
export default LeftEngineThrustReverser2;
