...
const LeftIgnitionStatus = () => {
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'741001'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'left engine ignition status'} right={'1/1'} />
...
export default LeftIgnitionStatus;
