...
const RightEngineEcs = () => {
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'302002'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'Right engine ECS'} right={'1/1'} />
