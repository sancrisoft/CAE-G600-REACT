...
const RightOperationalIndication2 = () => {
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'771008'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'right engine operational indication'} right={'2/4'} />
      <DynamicTable data={data} mainHeaders={tableHeader} />
    </DefaultLayout>
  );
};

export default RightOperationalIndication2;
