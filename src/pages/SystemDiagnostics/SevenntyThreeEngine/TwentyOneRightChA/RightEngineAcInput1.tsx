...
const RightEngineAcInput1 = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'fwd',
      href: '/systemdiagnostics/seventythreengine/twnetyonerightcha/rightengineacinput2',
      disabled: false,
      position: 5,
    },
  ];
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'732003'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'right engine a/c input eec echo'} right={'1/2'} />
...
export default RightEngineAcInput1;
