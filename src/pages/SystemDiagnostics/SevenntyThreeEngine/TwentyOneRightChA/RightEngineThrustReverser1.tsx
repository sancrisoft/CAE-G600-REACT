...
const RightEngineThrustReverser1 = () => {
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'703004'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'right engine thrust reverser status'} right={'1/3'} />
...
export default RightEngineThrustReverser1;
