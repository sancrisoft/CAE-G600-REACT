...
const RightEngineFuelStatus2 = () => {
  ...
  const data = [
    ...
    { parameter: 'FUEL INLET PRESSURE', statuses: ['510.9 PSIG', '510.9 PSIG'], customSpan: 2 },
    ...
    { parameter: '', statuses: ['', ''], customSpan: 2 },
    { parameter: 'FUEL FLTR DELTA PRESS', statuses: ['0.2 PSIG', '0.2 PSIG'], customSpan: 2 },
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'733004'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'right engine fuel system status'} right={'2/2'} />
...
export default RightEngineFuelStatus2;
