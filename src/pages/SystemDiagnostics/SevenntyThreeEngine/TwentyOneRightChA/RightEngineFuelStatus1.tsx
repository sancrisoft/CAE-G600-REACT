...
const RightEngineFuelStatus1 = () => {
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'733003'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'right engine fuel system status'} right={'1/2'} />
...
export default RightEngineFuelStatus1;
