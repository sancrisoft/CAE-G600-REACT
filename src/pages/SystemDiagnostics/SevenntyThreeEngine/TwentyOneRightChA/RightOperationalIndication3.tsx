...
const RightOperationalIndication3 = () => {
  ...
  const data = [
    ...
    { parameter: 'TLD STD TIME LEFT', statuses: ['125 HRS', '125 HRS'], customSpan: 2, alignCenter: true },
  ];
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'prev',
      href: '/systemdiagnostics/seventythreengine/twnetyonerightcha/rightoperationalindication2',
      disabled: false,
      position: 4,
    },
    {
      text: 'fwd',
      href: '/systemdiagnostics/seventythreengine/twnetyonerightcha/rightoperationalindication4',
      disabled: false,
      position: 5,
    },
  ];
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'771009'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'right engine operational indication'} right={'3/4'} />
      <DynamicTable data={data} mainHeaders={tableHeader} />
    </DefaultLayout>
  );
};

export default RightOperationalIndication3;
