...
const RightEngineSystem = () => {
  ...
  const data = [
    ...
    { parameter: 'PRESSURE ALTITUDE', statuses: ['153 FT', '153 FT'], customSpan: 2 },
    ...
    { parameter: 'VGV POSITION FDBK', statuses: ['97.8 %STK', '97.9 %STK'], customSpan: 2 },
    ...
    { parameter: 'LPC BLEED pos fdbk', statuses: ['255.8%STK', '255.8%STK'], customSpan: 2 },
    { parameter: 'lpc bleed t/m cmd', statuses: ['0.00 ma', '0.00 ma'], customSpan: 2 },
    { parameter: 'ACC POSITION CMD', statuses: ['0.0 %STK', '0.0 %STK'], customSpan: 2 },
    { parameter: 'ACC POSITION FDBK', statuses: ['0.1 %STK', '0.1 %STK'], customSpan: 2 },
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'752202'} right={['select prev to go back', 'select fwd to continue']} />}>
      <DataHeader left={'right engine air system'} right={'1/1'} />
      <DynamicTable data={data} mainHeaders={tableHeader} />
    </DefaultLayout>
  );
};

export default RightEngineSystem;
