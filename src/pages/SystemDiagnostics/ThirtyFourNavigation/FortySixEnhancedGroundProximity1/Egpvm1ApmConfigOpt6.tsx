...
const Egpvm1ApmConfigOpt6 = () => {
  const navigate = useNavigate();

  const mainHeaders = [
    { title: 'APM 3 EGPWM OPTIONS', alignLeft: true },
    { title: 'RNIC 4', customSpan: 1 },
  ];
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    },
    {
      ...
      disabled: false,
      position: 5,
      href: '/systemdiagnostics/thirtyfournavigation/fortysixenhancedgroundproximity1/egpvm1apmconfigopt7',
    },
  ];

  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'344606'} right={['select prev to go back', 'Select fwd to continue']} />}>
      <DataHeader left={'egpwm apm config options'} right={'6/8'} />
      <DynamicTable data={data} mainHeaders={mainHeaders} hasInsideBorder={false}/>
    </DefaultLayout>
  );
};

export default Egpvm1ApmConfigOpt6;
