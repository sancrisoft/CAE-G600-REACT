...
const Egpvm1ApmRaasConfigOpt9 = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    },
    {
      ...
      disabled: false,
      position: 5,
      href: '/systemdiagnostics/thirtyfournavigation/fortysixenhancedgroundproximity1/egpvm1apmraasconfigopt10',
    },
  ];
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'344609'} right={['select prev to go back', 'Select fwd to continue']} />}>
      <DataHeader left={'eg pwm apm raas config options'} right={'9/20'} />
...
export default Egpvm1ApmRaasConfigOpt9;
