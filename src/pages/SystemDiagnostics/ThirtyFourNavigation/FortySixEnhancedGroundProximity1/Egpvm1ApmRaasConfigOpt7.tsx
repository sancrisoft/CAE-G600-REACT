...
const Egpvm1ApmRaasConfigOpt7 = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    },
    {
      ...
      disabled: false,
      position: 5,
      href: '/systemdiagnostics/thirtyfournavigation/fortysixenhancedgroundproximity1/egpvm1apmraasconfigopt8',
    },
  ];
  ...
  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'344609'} right={['select prev to go back', 'Select fwd to continue']} />}>
      <DataHeader left={'eg pwm apm raas config options'} right={'7/20'} />
...
export default Egpvm1ApmRaasConfigOpt7;
