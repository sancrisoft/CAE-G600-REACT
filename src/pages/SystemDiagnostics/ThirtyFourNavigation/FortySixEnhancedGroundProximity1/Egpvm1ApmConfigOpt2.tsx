...
const Egpvm1ApmConfigOpt2 = () => {
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    },
    {
      ...
      disabled: false,
      position: 5,
      href: '/systemdiagnostics/thirtyfournavigation/fortysixenhancedgroundproximity1/egpvm1apmconfigopt3',
    },
  ];
...
export default Egpvm1ApmConfigOpt2;
