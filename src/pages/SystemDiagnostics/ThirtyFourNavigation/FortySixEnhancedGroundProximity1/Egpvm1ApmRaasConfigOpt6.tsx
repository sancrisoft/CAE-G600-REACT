...
const Egpvm1ApmRaasConfigOpt6 = () => {
  const navigate = useNavigate();

  const mainHeaders = [
    { title: 'APM 2 EGPWM OPTIONS', alignLeft: true },
    { title: 'NIC 2', customSpan: 1 },
  ];
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    },
    {
      ...
      disabled: false,
      position: 5,
      href: '/systemdiagnostics/thirtyfournavigation/fortysixenhancedgroundproximity1/egpvm1apmraasconfigopt7',
    },
  ];

  return (
    <DefaultLayout showNavBar navBarButtons={navBarButtons} footer={<DataFooter left={'344611'} right={['select prev to go back', 'Select fwd to continue']} />}>
      <DataHeader left={'eg pwm apm raas config options'} right={'6/20'} />
...
export default Egpvm1ApmRaasConfigOpt6;
