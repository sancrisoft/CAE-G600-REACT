...
const BusDiagnosticData4 = () => {
  const navigate = useNavigate();
  const tableHeaderRx = [{ title: 'PARAMETERS' }, { title: 'NIM2' }]
  const dataTx = [
    { parameter: 'BUS C - TIMESLOT 1', status1: 'PRESENT WITHOUT ERROR' },
    { parameter: 'BUS C - TIMESLOT 2', status1: 'PRESENT WITHOUT ERROR' },
    { parameter: 'BUS C - TIMESLOT 3', status1: 'PRESENT WITHOUT ERROR' },
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    },
    {
      ...
      disabled: false,
      position: 5,
      href: '/systemdiagnostics/twentythreecommunications/tworadiocabinettwo/busdiagnosticdata5',
    },
  ]
  ...
  return (
    ...
    >
      <DataHeader left={'nim 2 mac bus diagnostic data'} right={'5/6'} />
      <DataTable data={dataTx} mainHeaders={tableHeaderRx} leftAlign />
    </DefaultLayout>
  )
}

export default BusDiagnosticData4
