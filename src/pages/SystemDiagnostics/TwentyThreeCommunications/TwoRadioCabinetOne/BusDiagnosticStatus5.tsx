...
const BusDiagnosticStatus5 = () => {
  const navigate = useNavigate();
  const tableHeaderRx = [{ title: 'PARAMETERS' }, { title: 'NIM1' }]
  const dataTx = [
    { parameter: 'BUS C - TIMESLOT 15', status1: 'NOT PRESENT' },
    ...
    { parameter: 'BUS C - TIMESLOT 19', status1: 'NOT PRESENT' },
    ...
    { parameter: 'BUS C - TIMESLOT 23', status1: 'NOT PRESENT' },
  ...
  return (
    ...
    >
      <DataHeader left={'nim 1 mac bus diagnostic data'} right={'6/6'} />
      <DataTable data={dataTx} mainHeaders={tableHeaderRx} leftAlign />
    </DefaultLayout>
  )
}

export default BusDiagnosticStatus5
