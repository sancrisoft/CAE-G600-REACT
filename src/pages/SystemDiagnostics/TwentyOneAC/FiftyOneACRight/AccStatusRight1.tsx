...
const AccStatusRight1 = () => {
  const data = [
    { parameter: 'LLV ARNC RX FAULT', status1: true, status2: true },
  ...
  const data1 = [
    ...
    { parameter: 'R PACK ON 28V DISCRETE', status1: true, status2: true },
  ...
  const navBarButtons: NavBarButtonType[] = [
    ...
    {
      text: 'FWD',
      href: '/systemdiagnostics/twentyoneac/fiftyoneacright/accstatusright2',
      disabled: false,
      position: 5,
    },
  ]
  ...
  return (
    <DefaultLayout
      ...
      footer={<DataFooter left={'215110'} right={['Select prev to go back', 'Select fwd to continue']} />}
    >
      <DataHeader left={'Right air cond controller status'} right={'2/6'} isTitleLeft />
      <Legend />
...
export default AccStatusRight1
